...
<div class="page-container">
   <form action="message_message.do">
   <div class="text-c"> 
		<input type="text" class="input-text" style="width:250px" placeholder="输入留言人名称" id="" name="xm" value="${Obj.xm}"  >
...
function admin_del(id){
	layer.confirm('确认要删除吗？',function(index){
		...
		window.location.href=ctx+"/message_delete.do?id="+id;
	});
}
/*管理员-编辑*/
