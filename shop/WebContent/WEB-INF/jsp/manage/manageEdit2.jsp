...
<article class="page-container">
	<div style="width: 400px;">
	 <form class="form form-horizontal" id="form-admin-add" action="manage_editmanage2.do" method="post">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" value="${ma.passWord}" placeholder="密码" id="password" name="passWord">
		</div>
	</div>
	<div class="row cl">
