...
<div class="page-container">
   <form action="dd_dd.do">
 <div class="text-c"> 
		<input type="text" class="input-text" style="width:250px" placeholder="输入订单编号" id="" name="code" value="${Obj.code}"  >
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
	    <span class="l">  
	                      <a href="javascript:;" onclick="admin_add('添加商品','${ctx}/goods_add.do','600','300')" class="btn btn-primary radius">
	...
	private Goods goods;//商品 -->
		...
		<tbody>
		 ...
		 <tr class="text-c">
				...
				<td>${man.user.userName}</td>
				<td>${man.goods.title}</td>
				<td class="td-manage">
...
function admin_del(id){
	layer.confirm('确认要删除吗？',function(index){
		...
		window.location.href=ctx+"/dd_delete.do?id="+id;
	});
}
/*管理员-编辑*/
