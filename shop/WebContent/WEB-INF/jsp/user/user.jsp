...
<div class="page-container">
   ...
   <div class="text-c"> 
		<input type="text" class="input-text" style="width:250px" placeholder="输入用户名称" id="" name="realName" value="${Obj.realName}">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
	   <%--  <span class="l">  
	                      <a href="javascript:;" onclick="admin_add('添加专题','${ctx}/special_addManage.do','600','300')" class="btn btn-primary radius">
	...
	private Date createTime; -->
		...
		<tbody>
		 ...
		 <tr class="text-c">
				...
				<td width="300">${spe.userName}</td>
                
				<td>${spe.passWord}</td>
				<td>${spe.phone}</td>
				<td>${spe.realName}</td>
				<td class="td-manage">
				 <a title="删除" href="javascript:;" onclick="admin_del('${spe.id}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</td>
			</tr>
		 </c:forEach>
		</tbody>
...
function admin_del(id){
	layer.confirm('确认要删除吗？',function(index){
		...
		delAdvertisementdelAdvertisement
