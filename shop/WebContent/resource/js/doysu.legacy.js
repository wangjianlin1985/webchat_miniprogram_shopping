/*! doysu v2.3.0 ~ Old IE Fucker | by doysu Team | (c) 2015 AllMobilize, Inc. | Licensed under MIT | 2015-04-08T06:04:29 UTC */
(function e(t, n, r) {
  function s(o, u) {
    if (!n[o]) {
      if (!t[o]) {
  ...
  2: [
    function(require, module, exports) {
      (function(global) {
        ...
        if (typeof $ === 'undefined') {
          throw new Error('doysu 2.x requires jQuery :-(\n' +
            '\u7231\u4e0a\u4e00\u5339\u91ce\u9a6c\uff0c\u53ef\u4f60' +
            '\u7684\u5bb6\u91cc\u6ca1\u6709\u8349\u539f\u2026');
        }
        ...
        $(document).on('changed.dom.amui', function(e) {
          ...
          //       use like this: <div data-dy-observe='key1, key2'>
        ...
        $(function() {
          ...
          if (window.navigator.standalone) {
            $html.addClass('dy-standalone');
          }

          $('.dy-topbar-fixed-top').length &&
            $body.addClass('dy-with-topbar-fixed-top');

          $('.dy-topbar-fixed-bottom').length &&
            $body.addClass('dy-with-topbar-fixed-bottom');

          // Remove responsive classes in .dy-layout
          var $layout = $('.dy-layout');
          $layout.find('[class*="md-block-grid"]').alterClass(
            'md-block-grid-*');
          $layout.find('[class*="lg-block-grid"]').alterClass(
            'lg-block-grid');

          // widgets not in .dy-layout
          $('[data-dy-widget]').each(function() {
            var $widget = $(this);
            // console.log($widget.parents('.dy-layout').length)
            if ($widget.parents('.dy-layout').length === 0) {
              $widget.addClass('dy-no-layout');
            }
          });
        });
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        var Alert = function(element, options) {
          ...
          this.$element.
          addClass('dy-fade dy-in').
          on('click.alert.amui', '.dy-close', function() {
        ...
        Alert.prototype.close = function() {
          var $this = $(this);
          var $target = $this.hasClass('dy-alert') ?
            $this :
            $this.parent('.dy-alert');

          $target.trigger('close.alert.amui');

          $target.removeClass('dy-in');

          function processAlert() {
            $target.trigger('closed.alert.amui').remove();
          }

          UI.support.transition && $target.hasClass('dy-fade') ?
            $target.
        ...
        // Init code
        $(document).on('click.alert.amui.data-api', '[data-dy-alert]',
          function(e) {
            var $target = $(e.target);
            $(this).addClass('dy-fade dy-in');
            $target.is('.dy-close') && $(this).alert('close');
          });
      ...
      (function(global) {
        ...
        Button.prototype.setState = function(state) {
          ...
          if (UI.support.animation && options.spinner &&
            ...
            options.loadingText = '<span class="dy-icon-' +
              options.spinner +
              ' dy-icon-spin"></span>' + options.loadingText;
        ...
        Button.prototype.toggle = function() {
          var changed = true;
          var $element = this.$element;
          var $parent = this.$element.parent('.dy-btn-group');

          if ($parent.length) {
            var $input = this.$element.find('input');

            if ($input.prop('type') == 'radio') {
              if ($input.prop('checked') && $element.hasClass('dy-active')) {
                changed = false;
              } else {
                $parent.find('.dy-active').removeClass('dy-active');
              }
            }

            if (changed) {
              $input.prop('checked', !$element.hasClass('dy-active')).trigger(
                'change');
            }
          }

          if (changed) {
            $element.toggleClass('dy-active');
            if (!$element.hasClass('dy-active')) {
              $element.blur();
            }
          }
        };
        ...
        // Init code
        $(document).on('click.button.amui.data-api', '[data-dy-button]',
          function(e) {
            var $btn = $(e.target);

            if (!$btn.hasClass('dy-btn')) {
              $btn = $btn.closest('.dy-btn');
            }
        ...
        UI.ready(function(context) {
          $('[data-dy-loading]', context).each(function() {
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        Collapse.prototype.open = function() {
          if (this.transitioning || this.$element.hasClass('dy-in')) {
            return;
          }
          ...
          this.$element
            .removeClass('dy-collapse')
            .addClass('dy-collapsing').height(0);

          this.transitioning = 1;

          var complete = function() {
            this.$element.
            removeClass('dy-collapsing').
            addClass('dy-collapse dy-in').
            height('');
        ...
        Collapse.prototype.close = function() {
          ...
          this.$element.addClass('dy-collapsing').
          removeClass('dy-collapse dy-in');
        ...
        Collapse.prototype.toggle = function() {
          this[this.$element.hasClass('dy-in') ? 'close' : 'open']();
        };
        ...
        function Plugin(option) {
          return this.each(function() {
            ...
            var options = $.extend({}, Collapse.DEFAULTS,
              UI.utils.options($this.attr('data-dy-collapse')),
        ...
        // Init code
        $(document).on('click.collapse.amui.data-api', '[data-dy-collapse]',
          function(e) {
            var href;
            var $this = $(this);
            var options = UI.utils.options($this.attr('data-dy-collapse'));
            ...
            if (!data || !data.transitioning) {
              if ($parent) {
                // '[data-dy-collapse*="{parent: \'' + parent + '"]
                $parent.find('[data-dy-collapse]').not($this).addClass(
                  'dy-collapsed');
              }

              $this[$target.hasClass('dy-in') ? 'addClass' :
                'removeClass']('dy-collapsed');
            }
  ...
  6: [
    function(require, module, exports) {
      (function(global) {
        ...
        var Dimmer = function() {
          this.id = UI.utils.generateGUID('dy-dimmer');
        ...
        Dimmer.DEFAULTS = {
          tpl: '<div class="dy-dimmer" data-dy-dimmer></div>'
        };
        ...
        Dimmer.prototype.close = function(relatedElement, force) {
          ...
          $element.removeClass('dy-active').trigger('close.dimmer.amui');
        ...
        Dimmer.prototype.setScrollbar = function() {
          ...
          $body.addClass('dy-dimmer-active');
  ...
  7: [
    function(require, module, exports) {
      (function(global) {
        ...
        // var toggle = '[data-dy-dropdown] > .dy-dropdown-toggle';
        ...
        var Dropdown = function(element, options) {
          ...
          this.active = this.$element.hasClass('dy-active') ? true :
            false;
          this.animating = null;
        ...
        Dropdown.DEFAULTS = {
          animation: 'dy-animation-slide-top-fixed',
          boundary: window,
          justify: undefined,
          selector: {
            dropdown: '.dy-dropdown-content',
            toggle: '.dy-dropdown-toggle'
          },
          trigger: 'click'
        };
        ...
        Dropdown.prototype.open = function(e) {
          ...
          if ($toggle.is('.dy-disabled, :disabled')) {
            return;
          }
          ...
          $element.trigger('open.dropdown.amui').addClass('dy-active');
        ...
        Dropdown.prototype.close = function() {
          ...
          // fix #165
          // var animationName = this.options.animation + ' dy-animation-reverse';
          var animationName = 'dy-dropdown-animation';
          var $element = this.$element;
          var $dropdown = this.$dropdown;
        ...
        Dropdown.prototype.checkDimensions = function() {
          ...
          if ((width + (offset.left - boundaryOffset)) > boundaryWidth) {
            this.$element.addClass('dy-dropdown-flip');
          }
        };

        Dropdown.prototype.clear = function() {
          $('[data-dy-dropdown]').not(this.$element).each(function() {
   ...
   .on(eventOut + '.' + eventNS, $.proxy(this.close, this));
        ...
        function Plugin(option) {
          return this.each(function() {
            ...
            var data = $this.data('amui.dropdown');
            var options = $.extend({},
              UI.utils.parseOptions($this.attr('data-dy-dropdown')),
              typeof option == 'object' && option);
        ...
        // Init code
        UI.ready(function(context) {
          $('[data-dy-dropdown]', context).dropdown();
        });

        $(document).on('click.dropdown.amui.data-api', '.dy-dropdown form',
          function(e) {
            e.stopPropagation();
          });
  ...
  8: [
    function(require, module, exports) {
      (function(global) {
        ...
        $.flexslider.defaults = {
          namespace: "dy-", //{NEW} String: Prefix string attached to the class of every element generated by the plugin
          selector: ".dy-slides > li", //{NEW} Selector: Must match a simple pattern. '{container} > {slide}' -- Ignore pattern at your own peril
        ...
        // Init code
        UI.ready(function(context) {
          $('[data-dy-flexslider]', context).each(function(i, item) {
            var $slider = $(item);
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        var Modal = function(element, options) {
          ...
          this.$element = $(element);
          this.$dialog = this.$element.find('.dy-modal-dialog');

          if (!this.$element.attr('id')) {
            this.$element.attr('id', UI.utils.generateGUID('dy-modal'));
          }

          this.isPopup = this.$element.hasClass('dy-popup');
          this.isActions = this.$element.hasClass('dy-modal-actions');
          this.isPrompt = this.$element.hasClass('dy-modal-prompt');
          this.isLoading = this.$element.hasClass('dy-modal-loading');
        ...
        Modal.prototype.events = function() {
          var that = this;
          var $element = this.$element;
          var $ipt = $element.find('.dy-modal-prompt-input');
          ...
          $element.find('[data-dy-modal-close], .dy-modal-btn').
          on('click.close.modal.amui', function(e) {
            e.preventDefault();
            that.close();
          });

          $element.find('[data-dy-modal-confirm]').on(
          ...
          $element.find('[data-dy-modal-cancel]').
        ...
        // Init
        $doc.on('click.modal.amui.data-api', '[data-dy-modal]', function() {
          var $this = $(this);
          var options = UI.utils.parseOptions($this.attr('data-dy-modal'));
          var $target = $(options.target ||
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        OffCanvas.prototype.open = function(relatedElement) {
          ...
          if (!$element.length || $element.hasClass('dy-active')) {
            return;
          }
          ...
          var $html = $('html');
          var $body = $('body');
          var $bar = $element.find('.dy-offcanvas-bar').first();
          var dir = $bar.hasClass('dy-offcanvas-bar-flip') ? -1 : 1;

          $bar.addClass('dy-offcanvas-bar-' + effect);
          ...
          setTimeout(function() {
            $bar.addClass('dy-offcanvas-bar-active').width();
          }, 0);
          ...
          $element.on('click.offcanvas.amui', function(e) {
            ...
            if ($target.hasClass('dy-offcanvas-bar')) {
              return;
            }

            if ($target.parents('.dy-offcanvas-bar').first().length) {
              return;
            }
        ...
        OffCanvas.prototype.close = function(relatedElement) {
          ...
          function complete() {
            $body.removeClass('dy-offcanvas-page').
            css({
              width: '',
              height: '',
              'margin-left': '',
            ...
            $element.removeClass('dy-active');
            $bar.removeClass('dy-offcanvas-bar-active');
            $html.css('margin-top', '');
        ...
        OffCanvas.prototype.bindEvents = function() {
          var _this = this;
          $doc.on('click.offcanvas.amui', '[data-dy-dismiss="offcanvas"]',
            function(e) {
              e.preventDefault();
              _this.close();
            });
        ...
        // Init code
        $doc.on('click.offcanvas.amui', '[data-dy-offcanvas]', function(e) {
          e.preventDefault();
          var $this = $(this);
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        Popover.DEFAULTS = {
          ...
          open: false,
          target: undefined,
          tpl: '<div class="dy-popover">' +
            '<div class="dy-popover-inner"></div>' +
            '<div class="dy-popover-caret"></div></div>'
        };
        ...
        Popover.prototype.sizePopover = function sizePopover() {
          ...
          var $popCaret = $popover.find('.dy-popover-caret');
          ...
          $popover.css({
            left: '',
            top: ''
          }).removeClass('dy-popover-left ' +
            'dy-popover-right dy-popover-top dy-popover-bottom');
          ...
          if (popPosition === 'top' || popPosition === 'bottom') {
            ...
            if (popPosition === 'top') {
              ...
              $popover.addClass('dy-popover-top');
            }

            if (popPosition === 'bottom') {
              $popover.addClass('dy-popover-bottom');
            }
            ...
            $popover.addClass('dy-popover-left');
            if (popLeft < 5) {
              popLeft = triggerOffset.left + triggerWidth + popCaretSize;
              $popover.removeClass('dy-popover-left').addClass(
                'dy-popover-right');
            }
        ...
        Popover.prototype.open = function() {
          ...
          this.sizePopover();
          $popover.show().addClass('dy-active');
          this.active = true;
        };
        ...
        Popover.prototype.getPopover = function() {
          var uid = UI.utils.generateGUID('dy-popover');
          var theme = [];

          if (this.options.theme) {
            $.each(this.options.theme.split(','), function(i, item) {
              theme.push('dy-popover-' + $.trim(item));
            });
          }
        ...
        Popover.prototype.setContent = function(content) {
          ...
          this.$popover && this.$popover.find('.dy-popover-inner').empty().
          html(content);
        };
        ...
        function Plugin(option) {
          return this.each(function() {
            ...
            var options = $.extend({},
              UI.utils.parseOptions($this.attr('data-dy-popover')),
              typeof option == 'object' && option);
        ...
        // Init code
        UI.ready(function(context) {
          $('[data-dy-popover]', context).popover();
        });
  ...
  13: [
    function(require, module, exports) {
      (function(global) {
        ...
        // Init code
        UI.ready(function(context) {
          $('[data-dy-scrollspy-nav]', context).each(function() {
            var $this = $(this);
  ...
  15: [
    function(require, module, exports) {
      (function(global) {
        ...
        Sticky.DEFAULTS = {
          ...
          className: {
            sticky: 'dy-sticky',
            resetting: 'dy-sticky-resetting',
            stickyBtm: 'dy-sticky-bottom',
            animationRev: 'dy-animation-reverse'
          }
        };
        ...
        Sticky.prototype.init = function() {
          ...
          var $holder = $('<div class="dy-sticky-placeholder"></div>').css({
        ...
        Sticky.prototype.reset = function(force, cb) {
          ...
          var animation = (options.animation) ?
            ' dy-animation-' + options.animation : '';
          var complete = function() {
            $element.css({
              position: '',
              top: '',
     ...
     */
        ...
        $(window).on('load', function() {
          $('[data-dy-sticky]').each(function() {
            var $this = $(this);
            var options = UI.utils.options($this.attr('data-dy-sticky'));
